SQL* It is to create a new table 
syntax:-"create table table_name (colomn_name1  datatype1,  colomn_name2  datatype2 ,...);"
...
Table created.
SQL* now we have so insert some data in the table created.so the syntax of feeding data into the table is,
syntax:- "insert into table_name values (colomn_value1 , colomn_value2 ,....);"
...
SQL* To select all the attributes of the table ,syntax is ("select * from table_name;")
